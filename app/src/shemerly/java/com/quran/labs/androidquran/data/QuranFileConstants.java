...
public class QuranFileConstants {
  ...
  public static final String IMG_BASE_URL = BASE_HOST + "shemerly/";
  ...
  public static final String AYAHINFO_DIRECTORY = "shemerly/" + DATABASE_DIRECTORY;
  public static final String IMAGES_DIRECTORY = "shemerly";
