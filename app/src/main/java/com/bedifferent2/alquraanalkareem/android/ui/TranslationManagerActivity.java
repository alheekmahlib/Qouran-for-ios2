...
import com.bedifferent2.alquraanalkareem.android.dao.translation.TranslationHeader;
import com.bedifferent2.alquraanalkareem.android.dao.translation.TranslationItem;
import com.bedifferent2.alquraanalkareem.android.dao.translation.TranslationRowData;
...
import com.bedifferent2.alquraanalkareem.android.ui.adapter.TranslationsAdapter;
...
public class TranslationManagerActivity extends QuranActionBarActivity
  ...
  public void onErrorDownloadTranslations(String message) {
   ...
   /* Snackbar
        ...
        .make(translationRecycler, message, Snackbar.LENGTH_SHORT)
        .show();*/
  ...
  private void downloadItem(TranslationRowData translationRowData) {
    ...
    //todo add new Download Type to make it hit my url
    // start the download
